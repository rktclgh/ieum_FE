    ...
    <div className="flex w-full flex-col gap-2 border-b border-gray-50 py-3">
      <div className="flex w-full items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          {answer.isAi ? (
            <span className="rounded-full bg-primary-50 px-2 py-0.5 text-body-medium-14 text-primary-600">
              {messages.question.aiBadge}
            </span>
          ) : null}
          {answer.isAccepted ? (
            <span className="rounded-full bg-primary-600 px-2 py-0.5 text-body-medium-14 text-white">
