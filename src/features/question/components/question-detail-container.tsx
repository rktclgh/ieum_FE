...
function QuestionDetailContainer({
  ...
  return (
    <>
      ...
      {actionError && (
        <div className="bottom-anchor-auto fixed inset-x-0 bottom-[calc(6rem+max(var(--safe-area-bottom),var(--keyboard-inset,0px)))] z-[60] app-column flex justify-center px-4">
