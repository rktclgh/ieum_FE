 ...
 */
function MeetupDetailCard({ detail, pending, error, onJoin, onEnterRoom }: MeetupDetailCardProps) {
    ...
    <>
      {hasImage ? (
        <div className="relative h-40 w-full overflow-hidden rounded-3xl bg-gray-100">
          ...
          <img src={detail.imageUrl} alt={t.imageAlt} className="size-full object-cover" />
          <BottomSheetClose
