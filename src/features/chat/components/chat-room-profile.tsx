...
function ChatRoomProfile({ className, avatarSrc, secondaryAvatarSrc, title, ...props }: ChatRoomProfileProps) {
  return (
    <div
      ...
      {...props}
    >
      <ChatProfile src={avatarSrc} secondarySrc={secondaryAvatarSrc} size={96} />
