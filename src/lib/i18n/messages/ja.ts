...
export const ja: Messages = {
  ...
  pwa: {
    ...
    iosSteps: {
      modern: [
        ["下部のその他(", { icon: "ellipsis" }, ")ボタンをタップします。"],
        ["メニューから", { icon: "share" }, "「共有」を選びます。"],
        [{ icon: "square-plus" }, "「ホーム画面に追加」を探してタップします。"],
        ["右上の「追加」を押したら完了です!"],
      ],
      legacy: [
        ["下部の共有(", { icon: "share" }, ")ボタンをタップします。"],
        ["メニューから", { icon: "square-plus" }, "「ホーム画面に追加」を探してタップします。"],
        ["右上の「追加」を押したら完了です!"],
      ],
      unknown: [
        [
  ...
  question: {
    ...
    acceptedDialogStartChat: "個人チャット",
    reportConfirmCancel: "キャンセル",
    createTitle: "質問する",
    editTitle: "質問を編集",
  ...
  chat: {
    ...
    pinAction: "固定",
    unpinAction: "固定解除",
    pinReplaceConfirmTitle: "固定するチャットを変更しますか？",
    pinReplaceConfirmDescription: "固定できるチャットは1つだけです",
    pinReplaceConfirmButton: "変更",
    ...
    replyFromToLabel: (senderName, targetName) => `${senderName}さんが${targetName}さんに返信`,
    replyImageLabel: "写真",
    cancelReplyAction: "返信を取り消す",
    reportAction: "通報",
  ...
  schedule: {
    ...
    editorCreateTitle: "予定を登録",
    editorEditTitle: "予定を編集",
    ...
    deleteConfirmDescription: "削除した予定は元に戻せません。",
    editorRequired: "タイトル、時間、場所をすべて入力してください。",
    pastDateError: "今日より前の日付には予定を登録できません。",
    saveError: "予定を保存できませんでした。",
  ...
  report: {
    ...
    confirmScheduleTitle: (name) => `${name}の予定を通報します`,
    confirmScheduleTitleGeneric: "予定を通報します",
  ...
  notification: {
    ...
    settingsLabel: "通知設定",
    deleteModeLabel: "お知らせ削除モード",
    deleteItemLabel: "このお知らせを削除",
    deleteAll: "すべて削除",
    deleteModeClose: "閉じる",
    deleteAllConfirmTitle: "お知らせをすべて削除しますか？",
    deleteAllConfirmDescription: "削除したお知らせは復元できません。",
    deleteConfirmCancel: "キャンセル",
    deleteConfirmConfirm: "削除",
    bellLabel: "お知らせ",
