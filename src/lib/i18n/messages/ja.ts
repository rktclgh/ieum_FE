...
export const ja: Messages = {
  ...
  meetup: {
    ...
    closeMeetingButton: "募集を締め切る",
    cancelMeetingButton: "集まりを中止",
    leaveButton: "集まりから退出",
    ...
    closeConfirmTitle: "募集を締め切りますか？",
    closeConfirmDescription: "締め切ると新しい参加を受け付けません。",
    cancelConfirmTitle: "この集まりを取り消しますか？",
    cancelConfirmDescription: "取り消すと元に戻せません。",
    errors: {
  ...
  question: {
    ...
    contentPlaceholder: "聞きたい内容を入力してください",
    locationLabel: "位置",
    locationMissing: "先に地図で位置を選択してください。",
    addImageLabel: "写真を追加",
    submitButton: "投稿",
    errors: {
      FORBIDDEN: "権限がありません。",
