...
export const en: Messages = {
  ...
  question: {
    ...
    titlePlaceholder: "Question title (15 characters or less)",
  ...
  chat: {
    ...
    pinAction: "Pin",
    unpinAction: "Unpin",
    pinReplaceConfirmTitle: "Change the pinned chat?",
    pinReplaceConfirmDescription: "Only one chat can be pinned at a time.",
    pinReplaceConfirmButton: "Change",
  ...
  notification: {
    ...
    deleteAllConfirmDescription: "Deleted notifications can't be recovered.",
    deleteConfirmCancel: "Cancel",
    deleteConfirmConfirm: "Delete",
