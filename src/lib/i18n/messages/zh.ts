...
export const zh: Messages = {
  ...
  home: {
    ...
    pinStackMarkerLabel: (count) => `同一位置${count}个`,
  ...
  question: {
    ...
    acceptedDialogStartChat: "私聊",
    reportConfirmCancel: "取消",
    createTitle: "提问",
    editTitle: "编辑问题",
    titlePlaceholder: "问题标题（15字以内）",
  ...
  chat: {
    ...
    pinAction: "置顶",
    unpinAction: "取消置顶",
    pinReplaceConfirmTitle: "要更换置顶聊天吗？",
    pinReplaceConfirmDescription: "只能置顶一个聊天",
    pinReplaceConfirmButton: "更换",
    pinFailed: "置顶设置失败",
    ...
    replyFromToLabel: (senderName, targetName) => `${senderName} 回复了 ${targetName}`,
    replyImageLabel: "图片",
    cancelReplyAction: "取消回复",
    reportAction: "举报",
  ...
  schedule: {
    addButtonLabel: "添加日程",
    editorCreateTitle: "添加日程",
    editorEditTitle: "编辑日程",
    ...
    editAction: "编辑",
    deleteAction: "删除",
    deleteConfirmTitle: "要删除该日程吗?",
    deleteConfirmDescription: "删除后的日程无法恢复。",
    editorRequired: "请填写标题、时间和地点。",
    pastDateError: "不能在今天之前添加日程。",
    saveError: "无法保存日程。",
  ...
  report: {
    ...
    confirmScheduleTitle: (name) => `举报${name}的日程`,
    confirmScheduleTitleGeneric: "举报该日程",
  ...
  notification: {
    ...
    loadError: "无法加载通知。",
    settingsLabel: "通知设置",
    deleteModeLabel: "通知删除模式",
    deleteItemLabel: "删除此通知",
    deleteAll: "全部删除",
    deleteModeClose: "关闭",
    deleteAllConfirmTitle: "要删除全部通知吗？",
    deleteAllConfirmDescription: "删除后的通知无法恢复。",
    deleteConfirmCancel: "取消",
    deleteConfirmConfirm: "删除",
    bellLabel: "通知",
