...
export const zh: Messages = {
  ...
  my: {
    ...
    settings: {
      title: "设置",
      languageLabel: "语言",
      permissionsSectionTitle: "权限",
      cameraPermissionLabel: "相机权限",
      pushPermissionLabel: "推送通知权限",
      notificationsSectionTitle: "通知",
      notifyAllLabel: "全部通知",
      notifyMeetingLabel: "聚会通知",
      notifyQuestionLabel: "问题通知",
      notifyRadiusLabel: "通知范围",
      radiusOption: (km) => `${km}km`,
      locationLabel: "位置",
      locationUpdateAction: "更新我的位置",
      locationSublabel: "在地图上刷新你的位置。",
      locationUpdating: "正在更新位置...",
