...
export const ru: Messages = {
  ...
  my: {
    ...
    settings: {
      title: "Настройки",
      languageLabel: "Язык",
      permissionsSectionTitle: "Разрешения",
      cameraPermissionLabel: "Доступ к камере",
      pushPermissionLabel: "Push-уведомления",
      notificationsSectionTitle: "Уведомления",
      notifyAllLabel: "Все уведомления",
      notifyMeetingLabel: "Уведомления о встречах",
      notifyQuestionLabel: "Уведомления о вопросах",
      notifyRadiusLabel: "Радиус уведомлений",
      radiusOption: (km) => `${km}km`,
      locationLabel: "Местоположение",
      locationUpdateAction: "Обновить моё местоположение",
      locationSublabel: "Обновите своё местоположение на карте.",
      locationUpdating: "Обновление местоположения...",
      locationUpdated: "Ваше местоположение обновлено.",
      locationDenied: "Требуется разрешение на доступ к местоположению.",
