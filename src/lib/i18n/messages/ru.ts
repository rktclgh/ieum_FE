...
export const ru: Messages = {
  ...
  pwa: {
    title: "Добавьте Ieum на главный экран",
    ...
    iosSteps: {
      modern: [
        ["Нажмите кнопку «Ещё» (", { icon: "ellipsis" }, ") внизу."],
        ["Выберите ", { icon: "share" }, " «Поделиться» в меню."],
        [{ icon: "square-plus" }, " Найдите и нажмите «На экран «Домой»»."],
        ["Нажмите «Добавить» вверху справа — готово!"],
      ],
      legacy: [
        ["Нажмите кнопку «Поделиться» (", { icon: "share" }, ") внизу."],
        ["Найдите и нажмите ", { icon: "square-plus" }, " «На экран «Домой»» в меню."],
        ["Нажмите «Добавить» вверху справа — готово!"],
      ],
      unknown: [
        [
  ...
  question: {
    ...
    acceptedDialogStartChat: "Личный чат",
    ...
    errors: {
      ...
      VALIDATION_FAILED: "Проверьте введённые данные.",
      INVALID_IMAGE: "Не удалось проверить изображение. Прикрепите его снова.",
      QUESTION_RESOLVED: "Уже решённый вопрос нельзя редактировать.",
  ...
  chat: {
    ...
    pinReplaceConfirmTitle: "Изменить закреплённый чат?",
    pinReplaceConfirmDescription: "Закрепить можно только один чат.",
    pinReplaceConfirmButton: "Изменить",
    ...
    replyFromToLabel: (senderName, targetName) => `${senderName} отвечает ${targetName}`,
    replyImageLabel: "Фото",
    cancelReplyAction: "Отменить ответ",
    reportAction: "Пожаловаться",
  ...
  schedule: {
    ...
    editorCreateTitle: "Добавить событие",
    editorEditTitle: "Изменить событие",
    titlePlaceholder: "Название события",
    dateLabel: "Дата",
    timePlaceholder: "Выберите время",
    locationPlaceholder: "Выберите место",
    createAction: "Добавить",
    updateAction: "Сохранить",
    editAction: "Изменить",
    deleteAction: "Удалить",
    deleteConfirmTitle: "Удалить это событие?",
    deleteConfirmDescription: "Удалённое событие нельзя восстановить.",
    editorRequired: "Введите название, время и место.",
    pastDateError: "Нельзя добавить событие раньше сегодняшнего дня.",
  ...
  report: {
    ...
    confirmScheduleTitle: (name) => `Пожаловаться на событие ${name}`,
    confirmScheduleTitleGeneric: "Пожаловаться на это событие",
  ...
  notification: {
    ...
    deleteAllConfirmDescription: "Удалённые уведомления нельзя восстановить.",
    deleteConfirmCancel: "Отмена",
    deleteConfirmConfirm: "Удалить",
